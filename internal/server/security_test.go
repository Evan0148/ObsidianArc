...
func TestAdminRoutesRequireAnAdministrator(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodPost, "/api/admin/invites", map[string]any{"count": 1}},
		{http.MethodDelete, "/api/admin/invites/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
		{http.MethodGet, "/api/admin/invites/01ARZ3NDEKTSV4RRFFQ69G5FAV/uses", nil},
		{http.MethodGet, "/api/admin/invites/stats", nil},
		...
		{http.MethodGet, "/api/admin/security/two-factor", nil},
		...
		{http.MethodDelete, "/api/admin/users/01ARZ3NDEKTSV4RRFFQ69G5FAV/cards/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
		...
		{http.MethodGet, "/api/admin/users/01ARZ3NDEKTSV4RRFFQ69G5FAV/sessions", nil},
		{http.MethodDelete, "/api/admin/users/01ARZ3NDEKTSV4RRFFQ69G5FAV/sessions/0123456789abcdef", nil},
		{http.MethodDelete, "/api/admin/users/01ARZ3NDEKTSV4RRFFQ69G5FAV/sessions", nil},
		...
		{http.MethodGet, "/api/admin/feedback", nil},
		{http.MethodGet, "/api/admin/feedback/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
		{http.MethodPost, "/api/admin/feedback/01ARZ3NDEKTSV4RRFFQ69G5FAV/replies", map[string]any{"body": "x"}},
		{http.MethodDelete, "/api/admin/feedback/01ARZ3NDEKTSV4RRFFQ69G5FAV/replies/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
		{http.MethodPatch, "/api/admin/feedback/01ARZ3NDEKTSV4RRFFQ69G5FAV", map[string]any{"status": "resolved"}},
		{http.MethodDelete, "/api/admin/feedback/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
		{http.MethodGet, "/api/admin/applications", nil},
		{http.MethodPost, "/api/admin/applications", map[string]any{"name": "App", "redirect_uris": "https://x.example.com/cb"}},
		{http.MethodPatch, "/api/admin/applications/01ARZ3NDEKTSV4RRFFQ69G5FAV", map[string]any{"name": "x"}},
		{http.MethodPost, "/api/admin/applications/01ARZ3NDEKTSV4RRFFQ69G5FAV/secret", nil},
		{http.MethodDelete, "/api/admin/applications/01ARZ3NDEKTSV4RRFFQ69G5FAV", nil},
