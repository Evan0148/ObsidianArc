...
export const ADMIN_FEATURES: AdminFeatureItem[] = [
  ...
  },
  {
    id: 'secApplications',
    pageSlug: 'security',
    titleKey: 'secApplications',
    searchKeys: ['applicationsHint', 'applicationRegister', 'applicationRedirects',
      'applicationPublicField', 'applicationTrustedField'],
    keywords: ['用本站账号登录', '对外登录', '开放登录', 'OIDC', 'OpenID Connect', '单点登录', 'SSO',
      '应用登记', 'client id', 'client secret', 'sign in with', 'identity provider', 'oidc'],
  },
  {
    id: 'secSignupReview',
    pageSlug: 'security',
